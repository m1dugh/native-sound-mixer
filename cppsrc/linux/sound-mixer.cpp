...
namespace SoundMixer
{
	...
	{
		return Napi::Number::New(info.Env(), reinterpret_cast<_AudioSession *>(pSession)->GetVolume());
	}
	...
	{
		return Napi::Boolean::New(info.Env(), reinterpret_cast<_AudioSession *>(pSession)->GetMute());
	}
